...
from read_mixed import (extract_t_fromfile, HISQ_index, reshape_HISQ, wmatrix)
                        #gx, gy, gz, gt, g5, id4)
...
def main(argv=None):                                                                                          
    ...
    for x,y,z,t in (0,0,0,0), (1,1,1,1), (10,11,12,13), (13,14,15,16):
        ...
        for c1 in range(nc):
            for c2 in range(nc):
                ...
                print 'Wilsonized data (Kentucky):'
                for s1 in range(ns):
                    for s2 in range(ns):
